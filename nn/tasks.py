...
from .Addmoduels.ldv3 import *
from .Addmoduels.ResNet import *
from .Addmoduels.multiscale import *
from .Addmoduels.sknet import *
import torch
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m is HGBlock:
                ...
                n = 1
        elif m in {NewAttentionModule1,MultiscaleAttentionModule,SKConv}:
            c2 = ch[f]
            args = [c2, *args]
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect,RTDETRDecoder)):
                return "detect"
